...
extern void total_print_partition_stats();

extern map<FILE*, int> file_map;
extern vector<int> optimised_partitions;
extern uint64_t current_cycles;
// cpu
class O3_CPU {
  public:
    uint32_t cpu;
...
//anbhoir and muggu
void fill_btb(uint64_t trigger, uint64_t target, int trace_number);
