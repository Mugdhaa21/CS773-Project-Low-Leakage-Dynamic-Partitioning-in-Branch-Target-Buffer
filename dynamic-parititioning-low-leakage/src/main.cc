    ...
    for (int i=0; i<argc; i++) {	    
		...
		cout << last_dot << endl;
            ...
            if(ctr == 0){
                ...
                // cout<<"gunzip_command: "<<ooo_cpu[count_traces].gunzip_command<<endl;
            }else{
                if (trace2[last_dot - trace2 + 1] == 'g'){ // gzip format
            ...
            file_map[ooo_cpu[count_traces].trace_file] = 0;
            //anbhoir and muggu
            ooo_cpu[count_traces].trace_files[ctr-1] = popen(ooo_cpu[count_traces].gunzip_commands[ctr-1], "r");
            file_map[ooo_cpu[count_traces].trace_files[ctr-1]] = ctr;
            //////////
            ...
            cout<<ooo_cpu[count_traces].trace_files[ctr-1]<<endl;
           ctr++;
           count_traces = 0;
...
//	}
    ...
    //anbhoir and muggu optimised_partitions
    for(int i = 0; i < NUM_TRACES; i++){
        optimised_partitions.push_back(BTB_SET/NUM_TRACES);
    }
