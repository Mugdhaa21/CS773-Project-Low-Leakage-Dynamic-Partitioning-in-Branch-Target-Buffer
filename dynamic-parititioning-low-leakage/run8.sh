...
TRACE_DIR7="../utility-based-partitioning"  # path of the seventh trace file (excluding the trace file name)
TRACE_DIR8="../utility-based-partitioning"  # path of the eighth trace file (excluding the trace file name)
