...
(${binary} -warmup_instructions 25000000 -simulation_instructions 100000000 -traces ${TRACE_DIR1}/${trace1} ${TRACE_DIR2}/${trace2} ${TRACE_DIR3}/${trace3} ${TRACE_DIR4}/${trace4} ${TRACE_DIR5}/${trace5} ${TRACE_DIR6}/${trace6}) > results/mix-${num1}-${num2}-${num3}-${num4}-${num5}-${num6}.txt & # change the name of the folder as required